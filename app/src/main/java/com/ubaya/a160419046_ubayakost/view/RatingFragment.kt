...
import com.ubaya.a160419046_ubayakost.databinding.FragmentRatingBinding
...
class RatingFragment : Fragment() {
    ...
    private lateinit var dataBinding: FragmentRatingBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        dataBinding = FragmentRatingBinding.inflate(inflater, container, false)
